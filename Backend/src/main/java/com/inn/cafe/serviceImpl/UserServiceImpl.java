...
public class UserServiceImpl implements UserService {
        ...
        try {
            if (validaSignUpMap(requestMap)) {
                ...
                if (Objects.isNull(user)) {
                    ...
                    return AgriStockUtils.getResponeEntity("Successfully  Registered.", HttpStatus.OK);
                } else {
                    //System.out.println("Email already exits.");
                    return AgriStockUtils.getResponeEntity("Email already exits.", HttpStatus.BAD_REQUEST);
                }
            } else {
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return AgriStockUtils.getResponeEntity("User Status is updated Successfully", HttpStatus.OK);

                } else {
                    return AgriStockUtils.getResponeEntity("User id doesn't exist", HttpStatus.OK);
                }
            } else {
    ...
    public ResponseEntity<String> checkToken() {
        return AgriStockUtils.getResponeEntity("true", HttpStatus.OK);
    }
        ...
        try {
            ...
            if (!user.equals(null)) {
                if (user.getPassword().equals(requestMap.get("oldPassword"))) {
                    ...
                    userDao.save(user);
                    return AgriStockUtils.getResponeEntity("Password Updated Successfully", HttpStatus.OK);
                }
                return AgriStockUtils.getResponeEntity("Incorrect Old Password", HttpStatus.BAD_REQUEST);
            }
            return AgriStockUtils.getResponeEntity(AgriStockConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public ResponseEntity<String> forgetPassword(Map<String, String> requestMap) {
        ...
        try {
            ...
            if (!Objects.isNull(user) && !Strings.isNullOrEmpty(user.getEmail())) {
                ...
                emailUtil.forgetMail(user.getEmail() , "Credentials by Laksh Krushi Seva Kendra Talsande." , user.getPassword());
                return AgriStockUtils.getResponeEntity("Check Your mail for Credentials", HttpStatus.OK);
            }
